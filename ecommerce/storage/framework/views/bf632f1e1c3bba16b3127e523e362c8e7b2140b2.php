...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/listingCategories')); ?>"><i class="fa fa-bars"></i> <?php echo e(trans('labels.ListAllCategories')); ?></a></li>
                         ...
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateCategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/listingCategories')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
